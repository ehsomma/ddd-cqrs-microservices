...
public class Result
{
    ...
    /// <summary>
    /// Returns a success <see cref="Result{TValue}"/> with the specified <paramref name="value"/>.
    /// </summary>
    ...
    /// <summary>
    /// Creates a new <see cref="Result{TValue}"/> with the specified nullable value and the specified <paramref name="error"/>.
    /// </summary>
    /// <typeparam name="TValue">The result type.</typeparam>
    /// <param name="value">The result value.</param>
    /// <param name="error">The error in case the value is null.</param>
    /// <returns>A new instance of <see cref="Result{TValue}"/> with the specified <paramref name="value"/> or an error.</returns>
    public static Result<TValue> Create<TValue>(TValue value, IError error)
        where TValue : class
    {
    ...
    /// </summary>
    /// <param name="error">The error.</param>
    /// <returns>A new instance of <see cref="Result"/> with the specified <paramref name="error"/> and failure flag set.</returns>
    ...
    /// <summary>
    /// Returns a failure <see cref="Result{TValue}"/> with the specified <paramref name="error"/>.
    /// </summary>
    /// <typeparam name="TValue">The result type.</typeparam>
    /// <param name="error">The error.</param>
    /// <returns>A new instance of <see cref="Result{TValue}"/> with the specified <paramref name="error"/> and failure flag set.</returns>
    /// <remarks>
