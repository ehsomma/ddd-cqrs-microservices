...
* **Resilience**<br>
Inclusive si el Outbox pudo publicar satisfactoriamente al message broker, puede que al consumir el mensaje falle. Ahí tambien debes contemplar tomar una política de resiliencia . Ver: [DependencyInjection.cs](Src/Services/Shared/Records.Shared.Infra.MessageBroker.MassTransit.DI/DependencyInjection.cs) AddMessageBrokerWithMassTransit() L:114 for global configuratios and [PersonCreatedConsumerDefinition.cs](Src/Apps/EmailService/Consumers/PersonCreatedConsumerDefinition.cs) for especific configuration.
